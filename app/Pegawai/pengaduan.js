...
import { Text, SafeAreaView, Image, TouchableOpacity, View, TextInput } from "react-native";
        ...
        <SafeAreaView style={{flex:1, backgroundColor:'white', alignItems:'center'}}>
            <Image source={require('../../logo-bpjs.png')} style={{ width: 280, height: 43, margin: 30, padding: 20, marginBottom: 30 }}/>
                ...
                <View style={{ width: 250, marginTop: 15 }}>
                    <TextInput placeholder="Kategori" style={{ borderWidth: 0.7, borderRadius: 10, padding: 5, borderColor: 'grey' }} />
                </View>
                <View style={{ width: 250, marginTop: 15 }}>
                ...
                <View style={{ width: '70%', margin: 20, alignItems:'center', marginLeft:40, marginTop:50, marginBottom:50 }}>
                    <TouchableOpacity style={{backgroundColor: 'green', alignItems: 'center', padding: 20, borderRadius: 20 }} onPress={()=>{}}>
